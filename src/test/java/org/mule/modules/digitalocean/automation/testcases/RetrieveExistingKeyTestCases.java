...
public class RetrieveExistingKeyTestCases
    extends DigitaloceanTestParent
{
        ...
        throws Exception
    {
        ...
        initializeTestRunMessage("retrieveExistingKeyTestData");
    }
    ...
    @Test
    public void testRetrieveExistingKey()
        throws Exception
    {
        Object result = runFlowAndGetPayload("retrieve-existing-key");
