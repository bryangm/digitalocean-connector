...
public class ListAllDropletNeighborsTestCases
    extends DigitaloceanTestParent
{
        ...
        throws Exception
    {
        ...
        initializeTestRunMessage("listAllDropletNeighborsTestData");
    }
    ...
    @Test
    public void testListAllDropletNeighbors()
        throws Exception
    {
        Object result = runFlowAndGetPayload("list-all-droplet-neighbors");
