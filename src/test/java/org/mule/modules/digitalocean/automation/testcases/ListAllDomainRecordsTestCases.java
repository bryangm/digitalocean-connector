...
public class ListAllDomainRecordsTestCases
    extends DigitaloceanTestParent
{
        ...
        throws Exception
    {
        ...
        initializeTestRunMessage("listAllDomainRecordsTestData");
    }
    ...
    @Test
    public void testListAllDomainRecords()
        throws Exception
    {
        Object result = runFlowAndGetPayload("list-all-domain-records");
