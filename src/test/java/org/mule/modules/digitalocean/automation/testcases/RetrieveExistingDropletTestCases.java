...
public class RetrieveExistingDropletTestCases
    extends DigitaloceanTestParent
{
        ...
        throws Exception
    {
        ...
        initializeTestRunMessage("retrieveExistingDropletTestData");
    }
    ...
    @Test
    public void testRetrieveExistingDroplet()
        throws Exception
    {
        Object result = runFlowAndGetPayload("retrieve-existing-droplet");
