...
public class RetrieveExistingImageTestCases
    extends DigitaloceanTestParent
{
        ...
        throws Exception
    {
        ...
        initializeTestRunMessage("retrieveExistingImageTestData");
    }
    ...
    @Test
    public void testRetrieveExistingImage()
        throws Exception
    {
        Object result = runFlowAndGetPayload("retrieve-existing-image");
