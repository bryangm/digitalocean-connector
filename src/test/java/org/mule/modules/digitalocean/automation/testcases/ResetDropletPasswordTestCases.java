...
public class ResetDropletPasswordTestCases
    extends DigitaloceanTestParent
{
        ...
        throws Exception
    {
        ...
        initializeTestRunMessage("resetDropletPasswordTestData");
    }
    ...
    public void testResetDropletPassword()
        throws Exception
    {
        Object result = runFlowAndGetPayload("reset-droplet-password");
