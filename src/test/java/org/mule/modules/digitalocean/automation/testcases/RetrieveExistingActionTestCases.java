...
public class RetrieveExistingActionTestCases
    extends DigitaloceanTestParent
{
        ...
        throws Exception
    {
        ...
        initializeTestRunMessage("retrieveExistingActionTestData");
    }
    ...
    @Test
    public void testRetrieveExistingAction()
        throws Exception
    {
        Object result = runFlowAndGetPayload("retrieve-existing-action");
