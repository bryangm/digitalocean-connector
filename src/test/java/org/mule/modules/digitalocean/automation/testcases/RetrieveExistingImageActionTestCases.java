...
public class RetrieveExistingImageActionTestCases
    extends DigitaloceanTestParent
{
        ...
        throws Exception
    {
        ...
        initializeTestRunMessage("retrieveExistingImageActionTestData");
    }
    ...
    @Test
    public void testRetrieveExistingImageAction()
        throws Exception
    {
        Object result = runFlowAndGetPayload("retrieve-existing-image-action");
