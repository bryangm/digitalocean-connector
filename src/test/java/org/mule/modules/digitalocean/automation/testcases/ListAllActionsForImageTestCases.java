...
public class ListAllActionsForImageTestCases
    extends DigitaloceanTestParent
{
        ...
        throws Exception
    {
        ...
        initializeTestRunMessage("listAllActionsForImageTestData");
    }
    ...
    @Test
    public void testListAllActionsForImage()
        throws Exception
    {
        Object result = runFlowAndGetPayload("list-all-actions-for-image");
