...
public class CreateNewDropletTestCases
    extends DigitaloceanTestParent
{
        ...
        throws Exception
    {
        ...
        initializeTestRunMessage("createNewDropletTestData");
    }
    ...
    @Test
    public void testCreateNewDroplet()
        throws Exception
    {
        Object result = runFlowAndGetPayload("create-new-droplet");
