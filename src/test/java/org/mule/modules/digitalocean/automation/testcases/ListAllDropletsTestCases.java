...
public class ListAllDropletsTestCases
    extends DigitaloceanTestParent
{
        ...
        throws Exception
    {
        ...
        initializeTestRunMessage("listAllDropletsTestData");
    }
    ...
    @Test
    public void testListAllDroplets()
        throws Exception
    {
        Object result = runFlowAndGetPayload("list-all-droplets");
