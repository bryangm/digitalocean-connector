...
public class ListAllActionsForDropletTestCases
    extends DigitaloceanTestParent
{
        ...
        throws Exception
    {
        ...
        initializeTestRunMessage("listAllActionsForDropletTestData");
    }
    ...
    @Test
    public void testListAllActionsForDroplet()
        throws Exception
    {
        Object result = runFlowAndGetPayload("list-all-actions-for-droplet");
