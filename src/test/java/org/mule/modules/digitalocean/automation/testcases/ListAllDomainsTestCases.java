...
public class ListAllDomainsTestCases
    extends DigitaloceanTestParent
{
        ...
        throws Exception
    {
        ...
        initializeTestRunMessage("listAllDomainsTestData");
    }
    ...
    @Test
    public void testListAllDomains()
        throws Exception
    {
        Object result = runFlowAndGetPayload("list-all-domains");
