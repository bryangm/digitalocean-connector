...
public class UpdateExistingDomainRecordTestCases
    extends DigitaloceanTestParent
{
        ...
        throws Exception
    {
        ...
        initializeTestRunMessage("updateExistingDomainRecordTestData");
    }
    ...
    @Test
    public void testUpdateExistingDomainRecord()
        throws Exception
    {
        Object result = runFlowAndGetPayload("update-existing-domain-record");
