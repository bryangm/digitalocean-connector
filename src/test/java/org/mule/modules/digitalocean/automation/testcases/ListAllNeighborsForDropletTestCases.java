...
public class ListAllNeighborsForDropletTestCases
    extends DigitaloceanTestParent
{
        ...
        throws Exception
    {
        ...
        initializeTestRunMessage("listAllNeighborsForDropletTestData");
    }
    ...
    @Test
    public void testListAllNeighborsForDroplet()
        throws Exception
    {
        Object result = runFlowAndGetPayload("list-all-neighbors-for-droplet");
