...
public class ConvertImageToSnapshopTestCases
    extends DigitaloceanTestParent
{
        ...
        throws Exception
    {
        ...
        initializeTestRunMessage("convertImageToSnapshopTestData");
    }
    ...
    @Test
    public void testConvertImageToSnapshop()
        throws Exception
    {
        Object result = runFlowAndGetPayload("convert-image-to-snapshop");
