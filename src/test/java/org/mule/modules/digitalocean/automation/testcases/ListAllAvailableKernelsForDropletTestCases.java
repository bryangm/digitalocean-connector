...
public class ListAllAvailableKernelsForDropletTestCases
    extends DigitaloceanTestParent
{
        ...
        throws Exception
    {
        ...
        initializeTestRunMessage("listAllAvailableKernelsForDropletTestData");
    }
    ...
    @Test
    public void testListAllAvailableKernelsForDroplet()
        throws Exception
    {
        Object result = runFlowAndGetPayload("list-all-available-kernels-for-droplet");
