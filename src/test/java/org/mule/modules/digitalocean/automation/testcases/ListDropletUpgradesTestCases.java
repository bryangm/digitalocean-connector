...
public class ListDropletUpgradesTestCases
    extends DigitaloceanTestParent
{
        ...
        throws Exception
    {
        ...
        initializeTestRunMessage("listDropletUpgradesTestData");
    }
    ...
    @Test
    public void testListDropletUpgrades()
        throws Exception
    {
        Object result = runFlowAndGetPayload("list-droplet-upgrades");
