...
public class ListAllSnapshotsForDropletTestCases
    extends DigitaloceanTestParent
{
        ...
        throws Exception
    {
        ...
        initializeTestRunMessage("listAllSnapshotsForDropletTestData");
    }
    ...
    @Test
    public void testListAllSnapshotsForDroplet()
        throws Exception
    {
        Object result = runFlowAndGetPayload("list-all-snapshots-for-droplet");
