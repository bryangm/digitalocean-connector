...
public class UpgradeDropletTestCases
    extends DigitaloceanTestParent
{
        ...
        throws Exception
    {
        ...
        initializeTestRunMessage("upgradeDropletTestData");
    }
    ...
    @Test
    public void testUpgradeDroplet()
        throws Exception
    {
        Object result = runFlowAndGetPayload("upgrade-droplet");
