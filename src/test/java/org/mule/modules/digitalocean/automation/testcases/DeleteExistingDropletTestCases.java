...
public class DeleteExistingDropletTestCases
    extends DigitaloceanTestParent
{
        ...
        throws Exception
    {
        ...
        initializeTestRunMessage("deleteExistingDropletTestData");
    }
    ...
    @Test
    public void testDeleteExistingDroplet()
        throws Exception
    {
        Object result = runFlowAndGetPayload("delete-existing-droplet");
